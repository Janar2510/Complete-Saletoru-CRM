...
-- RLS Policies for user_notifications - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT FROM pg_policies 
    WHERE tablename = 'user_notifications' AND policyname = 'Users can view their own notifications'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT FROM pg_policies 
    WHERE tablename = 'user_notifications' AND policyname = 'Users can update their own notifications'
  ) THEN
...
-- RLS Policies for notification_templates - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT FROM pg_policies 
    WHERE tablename = 'notification_templates' AND policyname = 'Users can view notification templates'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT FROM pg_policies 
    WHERE tablename = 'notification_templates' AND policyname = 'Admins can manage notification templates'
  ) THEN
...
-- RLS Policies for notification_delivery_logs - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT FROM pg_policies 
    WHERE tablename = 'notification_delivery_logs' AND policyname = 'Users can view their own notification delivery logs'
  ) THEN
